...
#
# Stateful Artefacts — Cerro Torre build, sign, and verify pipeline
#
...
#   CT_KEY_ID       — Signing key identifier (default: stateful-artefacts-release)
