...
# Stateful Artefacts container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping stateful-artefacts..."
...
echo "Starting stateful-artefacts..."
echo "  Host: ${APP_HOST:-[::]}"
...
# Examples:
#   exec /app/stateful-artefacts
#   exec /app/release/bin/stateful-artefacts start
#   exec /app/stateful-artefacts serve --host "${APP_HOST}" --port "${APP_PORT}"
