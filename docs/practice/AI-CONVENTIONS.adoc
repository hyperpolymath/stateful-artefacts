...
3. Read `.machine_readable/6a2/anchors/ANCHOR.a2ml` for canonical authority boundaries.
...
7. Read `.machine_readable/6a2/AGENTIC.a2ml` for agent constraints.
...
- `.machine_readable/6a2/anchors/ANCHOR.a2ml` -- canonical authority and policy boundary
