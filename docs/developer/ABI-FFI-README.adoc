...
│  generated/abi/stateful_artefacts.h                │
└─────────────────┬───────────────────────────┘
                  │
                  │ imported by
                  ▼
...
```bash
cd src/abi
idris2 --cg c-header Types.idr -o ../../generated/abi/stateful_artefacts.h
```
...
2. **Generate C header**
   ```bash
   idris2 --cg c-header src/abi/Types.idr -o generated/abi/stateful_artefacts.h
   ```
