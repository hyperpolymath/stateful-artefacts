...
* **Library docs**: link:../developer/ABI-FFI-README.adoc[ABI-FFI-README] and link:../spec/ARTEFACT-STATE-RECORD.adoc[the record spec] (stateful-artefacts is a library, not a runnable app)
