...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/stateful-artefacts/security/advisories/new)
...
No PGP key is currently published for this project. For sensitive reports,
prefer GitHub Security Advisories (end-to-end encrypted) over plain email.
...
- This repository (`hyperpolymath/stateful-artefacts`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/stateful-artefacts/security/advisories)
...
When using Stateful Artefacts, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/stateful-artefacts/security/advisories)
...
*Thank you for helping keep Stateful Artefacts and its users safe.* 🛡️
