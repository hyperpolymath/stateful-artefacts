...
= Contributing — Stateful Artefacts
:revdate: 2026-MM-DD

== Audience

Developers working *on* `Stateful Artefacts`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/Stateful Artefacts.git
...
* Bugs in `Stateful Artefacts`: file at `hyperpolymath/Stateful Artefacts/issues`.
